...
describe('users', () => {
  ...
  it('should not be allowed to list details of all users', () => {
    chai
      .request(app)
      .get('/user')
      .set('Cookie', cookie)
  ...
  it('should not be allowed to view detail of other profile', () => {
    chai
      .request(app)
  ...
  it('should be allowed to view detail of own profile', () => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body.payload.role).to.be.equal(ROLE.USER)
      })
  })

  it('should not be allowed to delete any other user', () => {
    chai
      .request(app)
